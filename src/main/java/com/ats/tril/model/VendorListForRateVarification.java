...
public class VendorListForRateVarification {
	...
	public String toString() {
		return "VendorListForRateVarification [vendorId=" + vendorId + ", vendorCode=" + vendorCode + ", vendorName="
				+ vendorName + ", vendorAdd1=" + vendorAdd1 + ", vendorAdd2=" + vendorAdd2 + ", vendorAdd3="
				+ vendorAdd3 + ", vendorAdd4=" + vendorAdd4 + ", vendorStateId=" + vendorStateId + ", vendorState="
				+ vendorState + ", vendorCity=" + vendorCity + ", vendorContactPerson=" + vendorContactPerson
				+ ", vendorMobile=" + vendorMobile + ", vendorPhone=" + vendorPhone + ", vendorEmail=" + vendorEmail
				+ ", vendorGstNo=" + vendorGstNo + ", vendorApprvBy=" + vendorApprvBy + ", vendorItem=" + vendorItem
				+ ", vendorDate=" + vendorDate + ", vendorType=" + vendorType + ", isUsed=" + isUsed + ", createdIn="
				+ createdIn + ", deletedIn=" + deletedIn + ", rateTaxIncl=" + rateTaxIncl + ", rateTaxExtra="
				+ rateTaxExtra + "]";
	}
