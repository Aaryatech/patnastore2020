...
public class GetRmRateVerificationRecord {
	...
	public String toString() {
		return "GetRmRateVerificationRecord [rvrId=" + rvrId + ", rmId=" + rmId + ", suppId=" + suppId
				+ ", rateTaxExtra=" + rateTaxExtra + ", rateTaxIncl=" + rateTaxIncl + ", extra1=" + extra1 + ", extra2="
				+ extra2 + ", varchar1=" + varchar1 + ", varchar2=" + varchar2 + ", itemDesc=" + itemDesc
