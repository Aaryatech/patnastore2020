...
<body>
	...
	<c:url var="deleteItemFromEditEnquiryFromQuotation" value="/deleteItemFromEditEnquiryFromQuotation"></c:url>
	<c:url var="geQuotationDetailByQutIdForEditEnquiry" value="/geQuotationDetailByQutIdForEditEnquiry"></c:url>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Edit Enquiry From Quotation
							</h3>
						...
						<div class="box-content">
							...
							<form id="submitMaterialStore"
								action="${pageContext.request.contextPath}/submitEditEnqFromQuotation"
								method="post">
								...
								<div class="box-content">
									...
									<div class="col-md-3">
										<input class="form-control" id="qutNo" type="text" name="qutNo" value="${editEnquiry.indNo}"
											Readonly /> <input type="hidden"
											value="${editEnquiry.indId}" name="qutId" id="qutId"
											class="form-control">
									</div>
 ...
 -->
							...
							<!-- //------------------------------------------------------------------------------ -->
							<form id="submitList"
								action="${pageContext.request.contextPath}/submitEditEnqFromQuotationList"
								method="post">
	...
	<script>
		...
		function itemByIntendId() {
			...
			$
					.getJSON(
							'${geQuotationDetailByQutIdForEditEnquiry}',
												...
												function(key, itemList) {
													...
													tr
															.append($(
																	'<td ></td>')
																	.html(
																			'<input type="hidden"   id="indQty'+itemList.enqDetailId+'" name="indQty'+itemList.enqDetailId+'" value="'+itemList.enqQty+'" >'
													...
													tr
															.append($(
																	'<td ></td>')
																	.html(
																			'<input style="text-align:right; width:200px" type="text" id="indRemark'+itemList.enqDetailId+'" name="indRemark'+itemList.enqDetailId+'" value="'+itemList.enqRemark+'"  class="form-control" required>'));
		...
		function del(key)
		{
			...
			$
			.getJSON(
					'${deleteItemFromEditEnquiryFromQuotation}',
