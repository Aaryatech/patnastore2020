			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Rate Verification Record List
							</h3>
							<div class="box-tool">
						 ...
						 <form id="submitPurchaseOrder" action="${pageContext.request.contextPath}/showRmRateVarificationRecordList" method="get">
							...
							<div class="box-content">
									...
									<div class="col-md-3">
										<select class="form-control chosen" name="itemId" id="itemId"
											...
											<c:choose>
												<c:when test="${itemList.itemId==itemId}">
												<option value="${itemList.itemId}" selected>${itemList.itemDesc}</option> 
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-3">
										<select class="form-control chosen" name="vendId" id="vendId"
											required>
											<option value="0">All</option>
