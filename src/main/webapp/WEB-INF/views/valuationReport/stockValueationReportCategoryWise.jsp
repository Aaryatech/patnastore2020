...
<body>
				...
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						...
						<form id="submitPurchaseOrder"
							action="${pageContext.request.contextPath}/stockValueationReportCategoryWise"
							method="get">
									...
									<table class="table table-advance" id="table1">
										<thead>
											<tr class="bgpink">
												...
												<th class="col-md-4" style="text-align: left">CAT NAME</th>
													...
													<c:when
												 	...
												 	or categoryWiseReport.openingStock>0 or categoryWiseReport.opStockValue>0 }">
														<tr>
															...
															<td style="text-align: right"><c:out value="${sr+1}" /></td>
	...
	<script type="text/javascript">
		function genPdf() {
			window
					.open('${pageContext.request.contextPath}/stockValuetionReportCategoryWisePDF/');
		}
