...
<body onload="getSubDeptList()">
	...
	<c:url var="listForMrnGraphCategoryMonthWise"
		value="/listForMrnGraphCategoryMonthWise"></c:url>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Mrn Category Month Wise Report
							</h3>
							<div class="box-tool">
								...
								<div class="row">
									<div class="col-md-5" style="text-align: center">
										...
										<input type="button" value="PDF" class="btn btn-primary"
											...
											onclick="exportToExcel();"> <input type="button"
											class="btn btn-primary" onclick="showChart()" value="Graph">
									</div>
								</div>
								<br>
										...
										<tbody>
											...
											<c:forEach items="${categoryList}" var="categoryList"
												...
												<tr>
														...
														<c:forEach items="${list.monthList}" var="monthList"
															...
															<c:choose>
																<c:when test="${monthList.catId==categoryList.catId}">
																	...
																	<td><c:out value="${monthList.approvedQtyValue}" /></td>
													...
													<td><a
														href='javascript:getDetailReport(${categoryList.catId},/ ${categoryList.catDesc} /);'
			...
			$
					.getJSON(
							...
							function(data1) {
								...
								$
										.getJSON(
												'${listForMrnGraphCategoryMonthWise}',
												{
												...
												function(data) {
													...
													function drawStuff() {
														...
														document
																.getElementById("chart_div").style.border = "thin dotted red";
															...
															for (var j = 0; j < data.length; j++) {
																...
																for (var k = 0; k < data[j].monthList.length; k++) {
																	...
																	if (data1[i].catId == data[j].monthList[k].catId) {
																		...
																		arry
																				.push(data[j].monthList[k].approvedQtyValue);
														...
														function drawAprValueChart() {
															...
															for (var i = 0; i < data1.length; i++) {
																...
																for (var j = 0; j < data.length; j++) {
																	...
																	for (var k = 0; k < data[j].monthList.length; k++) {
																		...
																		if (data1[i].catId == data[j].monthList[k].catId
																				&& data[j].monthList[k].monthNo == 4) {

																			approvedQtyValue = approvedQtyValue
																					+ data[j].monthList[k].approvedQtyValue;
															...
															document
																	.getElementById("PiechartApr").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartApr'));
														...
														function drawMayValueChart() {
															...
															document
																	.getElementById("PiechartMay").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartMay'));
														...
														function drawJunValueChart() {
															...
															document
																	.getElementById("PiechartJun").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartJun'));
														...
														function drawJulValueChart() {
															...
															document
																	.getElementById("PiechartJul").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartJul'));
														...
														function drawAugValueChart() {
															...
															document
																	.getElementById("PiechartAug").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartAug'));
														...
														function drawSepValueChart() {
															...
															document
																	.getElementById("PiechartSep").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartSep'));
														...
														function drawOctValueChart() {
															...
															document
																	.getElementById("PiechartOct").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartOct'));
														...
														function drawNovValueChart() {
															...
															document
																	.getElementById("PiechartNov").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartNov'));
														...
														function drawDecValueChart() {
															...
															document
																	.getElementById("PiechartDec").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartDec'));
														...
														function drawJanValueChart() {
															...
															document
																	.getElementById("PiechartJan").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartJan'));
														...
														function drawFebValueChart() {
															...
															document
																	.getElementById("PiechartFeb").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartFeb'));
														...
														function drawMarValueChart() {
															...
															document
																	.getElementById("PiechartMar").style.border = "thin dotted red";
															var chart = new google.visualization.PieChart(
																	document
																			.getElementById('PiechartMar'));
														...
														drawMaterialChart();
														google.charts
																.setOnLoadCallback(drawAprValueChart);
														google.charts
																.setOnLoadCallback(drawMayValueChart);
														google.charts
																.setOnLoadCallback(drawJunValueChart);
														google.charts
																.setOnLoadCallback(drawJulValueChart);
														google.charts
																.setOnLoadCallback(drawAugValueChart);
														google.charts
																.setOnLoadCallback(drawSepValueChart);
														google.charts
																.setOnLoadCallback(drawOctValueChart);
														google.charts
																.setOnLoadCallback(drawNovValueChart);
														google.charts
																.setOnLoadCallback(drawDecValueChart);
														google.charts
																.setOnLoadCallback(drawJanValueChart);
														google.charts
																.setOnLoadCallback(drawFebValueChart);
														google.charts
																.setOnLoadCallback(drawMarValueChart);
													}
													;
	...
	<script type="text/javascript">
		function genPdf() {
			...
			window
					.open('${pageContext.request.contextPath}/mrnCategoryMonthWiseReportPdf/'
							+ typeName
							+ '/'
							+ isDevName
							+ '/'
