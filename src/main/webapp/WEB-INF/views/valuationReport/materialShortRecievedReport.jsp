			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Material Short Received Report
							</h3>
							<div class="box-tool">
						 ...
						 <form id="submitPurchaseOrder" action="${pageContext.request.contextPath}/materialShortRecievedReport" method="get">
					...
					<div class="table-responsive" style="border: 0" id="tbl">
						<table class="table table-advance" id="table1">  
								...
								<c:forEach items="${shortItemReportForPdf}" var="shortItemReportForPdf" varStatus="count">
											...
											<tr>
												...
												<td  ><c:out value="${shortItemReportForPdf.poNo}" /></td> 
											<td  ><c:out
													value="${shortItemReportForPdf.poDate}" /></td>
...
function showChart(){
	...
	<script type="text/javascript">
	function genPdf(){
		window.open('${pageContext.request.contextPath}/materialShortRecievedReportPdf/');
	}
