...
<body>
	...
	<c:url var="issueReportSubDeptWiseReport"
		value="/issueReportSubDeptWiseReport"></c:url>
							...
							<div class="col-md-12" style="text-align: center">
								...
								<div class="row">
									<div class="col-md-12" style="text-align: center">
										...
										<input type="button" class="btn search_btn"
													...
													<c:choose>
														<c:when
															...
															<td style="text-align: right"><a
																href="${pageContext.request.contextPath}/issueReportItemWise/${deptWiselist.deptId}"
	...
	<script type="text/javascript">
		function genPdf() {
			window
					.open('${pageContext.request.contextPath}/issueReportSubDeptWisePDF/');
		}
	</script>
							...
							function(data) {
								...
								function drawStuff() {
									...
									function drawAmtChart() {
										...
										var options = {
											'title' : 'Sub Department Issue Value',
											'width' : 550,
											'height' : 250
										};
