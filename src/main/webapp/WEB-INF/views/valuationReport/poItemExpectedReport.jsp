			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>PO Item Expected Report
							</h3>
							<div class="box-tool">
						 ...
						 <form id="submitPurchaseOrder" action="${pageContext.request.contextPath}/poItemExpectedReport" method="get">
					...
					<div class="table-responsive" style="border: 0" id="tbl">
						<table class="table table-advance" id="table1">  
								...
								<c:forEach items="${itemExpectedReport}" var="itemExpectedReport" varStatus="count">
...
function showChart(){
	...
	<script type="text/javascript">
	function genPdf(){
		window.open('${pageContext.request.contextPath}/poItemExpectedReportPdf/');
	}
