								...
								<table class="table table-advance" id="table1">
									<thead>
										<tr class="bgpink">
											...
											<th class="col-md-1">Gatepass Date</th>
											<th class="col-md-1">Gatepass No</th>
											<th class="col-md-1">Gatepass TYPE</th>
									...
									<tbody>
										...
										<c:forEach items="${getPassListForApprove}" var="getPassListForApprove" varStatus="count">
											<tr>
												...
												<td class="col-md-1"><c:out value="${getPassListForApprove.gpDate}" /></td>
												 
												<td class="col-md-1"><c:out value="${getPassListForApprove.gpNo}" /></td>
												<c:set var="type"></c:set>
												 
															<c:choose>
																<c:when test="${getPassListForApprove.gpType==0}">
																	<c:set var="type" value="Non Returnable"></c:set>
																</c:when>
																<c:when test="${getPassListForApprove.gpType==1}">
																	<c:set var="type" value="Returnable"></c:set>
																</c:when>
												...
												<td class="col-md-4"><c:out
														value="${getPassListForApprove.vendorName}" /></td>

												 

												<td> 
													<a href="${pageContext.request.contextPath}/approveGatePassDetail/${getPassListForApprove.gpId}/${approve}"><abbr
