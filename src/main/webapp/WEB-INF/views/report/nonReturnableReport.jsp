			...
			<div class="page-title">
				<div>
					<h1>
						...
						<i class="fa fa-file-o"></i>Non Returnable Report List
			...
			<div class="row" id="tbody0">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Non Returnable Report List
							</h3>
							<div class="box-tool">
			...
			<div class="row" id="tbody1" style="display: none;">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Non Returnable Vendorwise Report List
							</h3>
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/"> </a> <a
									data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
			...
			<div class="row" id="tbody2" style="display: none;">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Nonreturnable Itemwise Report List
							</h3>
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/"> </a> <a
									data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
