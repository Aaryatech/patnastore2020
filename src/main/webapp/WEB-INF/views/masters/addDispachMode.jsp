			...
			<!-- <div class="page-title">
				<div>
					<h1>
						...
						<i class="fa fa-file-o"></i>Add Dispach Mode
				...
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						...
						<div class=" box-content">
							<form id="addSupplier"
								action="${pageContext.request.contextPath}/insertDispachMode"
					...
					<div class="table-responsive" style="border: 0">
						<table class="table table-advance" id="table1">  
									...
									<a href="${pageContext.request.contextPath}/deleteDispatchMode/${dispatchModeList.dispModeId}" onClick="return confirm('Are you sure want to delete this record');"><span
