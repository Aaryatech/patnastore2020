				...
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						...
						<div class=" box-content">
							<form id="addSupplier"
								action="${pageContext.request.contextPath}/insertPaymentTerm"
										...
										<c:forEach items="${paymentTermsList}" var="paymentTermsList"
											...
											<tr>
												...
												<td><a
													...
													<a href="${pageContext.request.contextPath}/deletePaymentTerm/${paymentTermsList.pymtTermId}" onClick="return confirm('Are you sure want to delete this record');"><span
...
{
document.getElementById("pymtDesc").focus();
}
</script>
