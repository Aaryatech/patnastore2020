					...
					<div class="box">
						<div class="box-title">
							<h3>
								...
								</c:choose> Purchase Order Detail
							</h3>
							...
							<form id="submitMaterialStore"
								...
								<div class="box-content">
									...
									<c:forEach items="${typeList}" var="typeList"> 
															<c:choose>
																<c:when test="${typeList.typeId==poHeaderForApprove.poType}">
																	${typeList.typeName}
																</c:when>
