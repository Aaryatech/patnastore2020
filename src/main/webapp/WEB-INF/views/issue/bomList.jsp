			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="todayslist">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>BOM List
							</h3>
							<div class="box-tool">
					...
					<div class="table-responsive" style="border: 0">
						<table class="table table-advance" id="table1">  
								...
								<tbody>
									...
									<c:forEach items="${bomList}" var="getbomList"
													varStatus="count">
													...
													<c:when test="${getbomList.status==1}">
													  <c:set var = "status" value="Partially Issue"/>
													
													</c:when>
													
													<c:when test="${getbomList.status==2}">
													  <c:set var = "status" value="Completed Issue"/>
													...
													<tr>
													  ...
													  <td align="left">${getbomList.reqDate}  </td>
						...
						<td><a href="${pageContext.request.contextPath}/bomHeaderWithDetail/${getbomList.reqId}" class="action_btn" >
